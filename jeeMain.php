...
<body>
    ...
    <header>
        <div class="page-info">
            <h2 class="title">Jee Mains <span class="mob-none">-</span> Josaa Predictor</h2>
            <div class="instr">
    ...
    <main>
        <form id="form" class="form">
            <div class="selectors">
                ...
                <div class="state-container">
                    <span><img src="down-arrow-white.svg" alt="..." class="downImg"></span>
                    <select class="ddds" id="home-state">
                        <option value="Select HomeState">Select HomeState</option>
